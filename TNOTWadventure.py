...
class Functions:
        ...
        while True:
            ...
            # a map is displayed
               ...
               if playerInput == "eat":
                    ...
                    appBasicGUI.txtFrame.insert(INSERT, "You have a plesent converation with your someone of your fellow students  \n")
                    self.charisma +=1
                    break
    ...
    def fnMoney(self, money):
        ...
        while joints >= 10:
            ...
            if talons > 10:
                marks = marks + 1
                talons = talons - 10
        print str(joints) + " joints, " + str(talons) + " talons, and " + str(marks) + " marks"
        strFinalMoney = str(   "\n" + "\n" + str(marks) + " marks" +"\n" +  "\n" +  str(talons) + " talons" +"\n" + "\n" +str(joints) + " joints " )
    ...
    def fnHomeowrkRoom(self):
        appBasicGUI.txtFrame.insert(INSERT, "You are now in the practice/homework room.\n")
        appBasicGUI.txtFrame.see(END)
    ...
    def fnMastersRoom(self):
        ...
        appBasicGUI.txtFrame.insert(INSERT, "The masters don't seem to notice to you're presence in the room" + "\n")
        appBasicGUI.txtFrame.see(END)
